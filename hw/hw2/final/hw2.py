...
#       If this occurs before the end of the algorithm, this means there are no paths to the rest 
#       of the graph from any vertex in the first subtree. Thus, the start is naturally an
#       articulation point.
